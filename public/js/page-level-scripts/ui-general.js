var UIGeneral = function () {
    ...
    var handlePulsate = function () {
        ...
        if (jQuery().pulsate) {
            ...
            jQuery('#pulsate-success').pulsate({
                color: "#418F1A"
            });
            
            jQuery('#pulsate-danger').pulsate({
                color: "#bf1c56"
            });
            
            jQuery('#pulsate-warning').pulsate({
                color: "#E3C209"
            });
...
// ATENÇÃO! O código abaixo deve ser colocado dentro de algum " jQuery(document).ready(function() {  " já existente em alguma página OU criar o <script> na página. 
// Para não dar conflito com outros recursos do sistema. 
//
